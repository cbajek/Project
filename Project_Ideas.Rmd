...
# Simplify the shape files to improve performance
# county_shp <- rmapshaper::ms_simplify(county_shp, keep = 0.05, keep_shapes = TRUE)
# state_shp <- rmapshaper::ms_simplify(state_shp, keep = 0.05, keep_shapes = TRUE)
